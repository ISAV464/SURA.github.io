        ...
        <main class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div class="lg:col-span-1 flex justify-center lg:block">
                ...
                <section class="bg-red p-6 sm:p-8 rounded-3xl shadow-xl">
                    ...
                    <ul class="space-y-4">
                        <li class="p-4 rounded-2xl bg-sky-100 shadow">
                         ...
                         <!-- Columna de imagen (centro) -->
            <div class="lg:col-span-1 flex justify-center lg:block">
                <img src="https://www.toyotapanamericana.com/images/empresa/big-01_tcm39-85421.jpg"
                     alt="Toyota"
                     class="rounded-3xl shadow-lg w-full max-w-xs lg:max-w-none transform transition-transform duration-300 hover:scale-105">
                    </div> 
                        <li class="p-4 rounded-2xl bg-cyan-100 shadow">
                        ...
                        <li class="p-4 rounded-2xl bg-blue-100 shadow">
                         ...
                         <!-- Columna de imagen (centro) -->
            <div class="lg:col-span-1 flex justify-center lg:block">
                <img src="https://t.ctcdn.com.br/wZuhqyXLWgeykIYPxXlcVtsNPfg=/640x360/smart/i965221.jpeg"
                     alt="Toyota"
                     class="rounded-3xl shadow-lg w-full max-w-xs lg:max-w-none transform transition-transform duration-300 hover:scale-105">
                    </div> 
                        <li class="p-4 rounded-2xl bg-indigo-100 shadow">
                        ...
                        <li class="p-4 rounded-2xl bg-purple-100 shadow">
                        ...
                        <!-- Columna de imagen (centro) -->
            <div class="lg:col-span-1 flex justify-center lg:block">
                <img src="https://www.marketersbyadlatina.com/uploads/img/2955-630-toyota-empleadosmasfelices-944x499px.jpg"
                     alt="Toyota"
                     class="rounded-3xl shadow-lg w-full max-w-xs lg:max-w-none transform transition-transform duration-300 hover:scale-105">
                    </div> 
                        <li class="p-4 rounded-2xl bg-fuchsia-100 shadow">
                        ...
                        <li class="p-4 rounded-2xl bg-pink-100 shadow">
